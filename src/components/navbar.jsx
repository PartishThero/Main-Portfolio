...
const FRAME_W = 384;
const FRAME_H = 341;
const SCALE   = 4; // divide by 4 to get display size
...
// (2,1) = focused glasses → default head
...
export default function Navbar() {
  ...
  const activeLink = ({ isActive }) =>
    isActive
      ? 'text-(--accent-main)'
      : 'hover:text-(--accent-main) transition-colors';
  ...
  return (
    ...
    >
      ...
      {/* RIGHT: nav links */}
      <div className="flex gap-10 font-mono text-sm tracking-widest text-(--text-secondary)">
