    ...
    <div className="min-h-screen flex flex-col items-center justify-center" style={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', paddingTop: '7rem', paddingBottom: '4rem',}}>
      <div className="flex flex-col gap-12 w-full" style={{ maxWidth: '680px', padding: '0 clamp(1.25rem, 6vw, 1.5rem)' }} >
        ...
        <div className="flex flex-col gap-3">
          <motion.p {...fadeUp(0)} className="font-mono text-xs uppercase" style={{ letterSpacing: '0.2em', color: 'var(--accent-secondary)' }}> / skills </motion.p>

          <motion.h2 {...fadeUp(0.1)} className="leading-none" style={{ fontFamily: '"Boldonse", system-ui', fontSize: 'clamp(2.25rem, 6vw, 3.5rem)' }} >
            What I{' '} <span style={{ color: 'var(--accent-main)' }}>work with.</span>
          </motion.h2>
